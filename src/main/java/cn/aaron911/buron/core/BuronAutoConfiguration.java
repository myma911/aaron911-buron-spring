...
public class BuronAutoConfiguration {
    ...
    @Autowired
    private BuronProperty properties;
    ...
    @Bean
    public IBuronProcessor buronProcessor() {
        return new BuronProcessorImpl();
    }
    ...
    public Cache buronCache() {
        ...
        if ("redis".equalsIgnoreCase(type)) {
            ...
            log.error("Buron cache type error, check property aaron911.buron.type");
            throw new RuntimeException("Buron cache type error, check property aaron911.buron.type");
        }
    }
